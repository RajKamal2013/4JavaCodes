...
public class RegEx {
    ...
    public static String infix2postfix(String regex) {
        ...
        System.out.println("Formatted String : " + formattedRegEx);
            ...
            switch (c) {
                ...
                default:
                    while(stack.size() > 0) {
                        ...
                        Integer peekCharacterPrecedence = getPrecedence(peekedChar);
                        Integer currentCharacterPrecendece = getPrecedence(c);

                        if (peekCharacterPrecedence >= currentCharacterPrecendece) {
                            postfix += stack.pop();
                        } else {
                            break;
                        }
